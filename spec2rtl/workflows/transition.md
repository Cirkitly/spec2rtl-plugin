...
- [x] Phase 1: Architecture (completed 2026-02-15)
- [ ] Phase 2: Memory Controller ← Next
- [ ] Phase 3: CPU Core
...
| -------------------- | -------------- | ----------- | ---------- |
| 1. Architecture      | 3/3            | Complete    | 2026-02-15 |
| 2. Memory Controller | 0/2            | Not started | -          |
| 3. CPU Core          | 0/1            | Not started | -          |
```
...
- [ ] 100MHz System Clock
- [ ] Support for 4GB DDR4

### Out of Scope

- PCIe Interface — complexity not needed for v1
```

After (Phase 2 shipped AXI4, discovered 100MHz is too slow for DDR4 controller):

```markdown
### Validated

- ✓ AXI4-Lite Control Interface — Phase 2

### Active

- [ ] 100MHz System Clock
- [ ] Support for 4GB DDR4
- [ ] Add CDC for 200MHz DDR PHY clock
...
Phase: 2 of 4 (Memory Controller)
...
Phase: 3 of 4 (CPU Core)
Plan: Not started
Status: Ready to plan
Last activity: 2026-02-20 — Phase 2 complete, transitioned to Phase 3
...
- ⚠️ [Phase 1] Reset tree routing congestion unknown
- ⚠️ [Phase 2] DDR4 PHY timing closure risk at 1600MT/s
```

After (if Reset tree was solved in Phase 2):
...
Exit skill and invoke SlashCommand("/s2r:plan-phase [X+1]")
...
**Also available:**
- `/s2r:discuss-phase [X+1]` — gather context first (Micro-arch, PPA)
- `/s2r:research-phase [X+1]` — investigate IPs/Protocols
- Review roadmap
...
Exit skill and invoke SlashCommand("/s2r:complete-milestone {version}")
...
**Complete Milestone {version}** — archive and prepare tape-out/release
