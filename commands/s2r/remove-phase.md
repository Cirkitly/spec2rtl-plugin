...
- Example: `/s2r:remove-phase 17` → phase = 17
- Example: `/s2r:remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /s2r:remove-phase <phase-number>
Example: /s2r:remove-phase 17
```
...
To abandon current work, use /s2r:pause-work instead.
```
...
Would you like to:
- `/s2r:progress` — see updated roadmap status
