...
<objective>
Capture an idea, task, or issue that surfaces during a Spec2RTL session as a structured todo for later work.
...
- `/s2r:add-todo Add auth token refresh` → title = "Add auth token refresh"
...
2. Add another todo
3. View all todos (/s2r:check-todos)
```
</step>
