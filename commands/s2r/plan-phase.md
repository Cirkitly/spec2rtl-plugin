...
**Orchestrator role:** Parse arguments, validate phase, research domain (unless skipped or exists), spawn s2r-planner agent, verify plans with s2r-plan-checker, iterate until plans pass or max iterations reached, present results.
...
**If not found:** Error - user should run `/s2r:new-project` first.
...
|-------|---------|----------|--------|
| s2r-phase-researcher | opus | sonnet | haiku |
| s2r-planner | opus | opus | sonnet |
| s2r-plan-checker | sonnet | sonnet | haiku |
...
<phase_context>
**IMPORTANT:** If CONTEXT.md exists below, it contains user decisions from /s2r:discuss-phase.
...
```
Task(
  prompt="First, read ~/.claude/agents/s2r-phase-researcher.md for your role and instructions.\n\n" + research_prompt,
...
## 8. Spawn s2r-planner Agent

Display stage banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Spec2RTL ► PLANNING PHASE {X}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
IMPORTANT: If phase context exists below, it contains USER DECISIONS from /s2r:discuss-phase.
...
```
Task(
  prompt="First, read ~/.claude/agents/s2r-planner.md for your role and instructions.\n\n" + filled_prompt,
  subagent_type="general-purpose",
  model="{planner_model}",
...
## 10. Spawn s2r-plan-checker Agent

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Spec2RTL ► VERIFYING PLANS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Task(
  ...
  subagent_type="s2r-plan-checker",
  model="{checker_model}",
...
Spawn s2r-planner with revision prompt:
...
- /s2r:plan-phase {X} --research — re-research first
...
- [ ] s2r-phase-researcher spawned with CONTEXT.md (constrains research scope)
- [ ] Existing plans checked
- [ ] s2r-planner spawned with context (CONTEXT.md + RESEARCH.md)
- [ ] Plans created (PLANNING COMPLETE or CHECKPOINT handled)
- [ ] s2r-plan-checker spawned with CONTEXT.md (verifies context compliance)
