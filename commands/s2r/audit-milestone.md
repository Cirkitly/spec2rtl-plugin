...
<execution_context>
<!-- Spawns s2r-integration-checker agent which has all audit expertise baked in -->
</execution_context>
...
|-------|---------|----------|--------|
| s2r-integration-checker | sonnet | sonnet | haiku |
...
Verify cross-phase wiring and E2E user flows.",
  subagent_type="s2r-integration-checker",
...
- /s2r:complete-milestone {version} — proceed anyway (accept tech debt)
