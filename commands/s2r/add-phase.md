...
- Example: `/s2r:add-phase Add authentication` → description = "Add authentication"
- Example: `/s2r:add-phase Fix critical performance issues` → description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: /s2r:add-phase <description>
Example: /s2r:add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /s2r:plan-phase {N} to break down)
...
**Also available:**
- `/s2r:add-phase <description>` — add another phase
- Review roadmap
...
- Don't use decimal numbering (that's /s2r:insert-phase)
- Don't create plans yet (that's /s2r:plan-phase)
