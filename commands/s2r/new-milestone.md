...
**After this command:** Run `/s2r:plan-phase [N]` to start execution.
</objective>

<execution_context>
@~/.claude/spec2rtl/references/questioning.md
@~/.claude/spec2rtl/references/ui-brand.md
@~/.claude/spec2rtl/templates/project.md
@~/.claude/spec2rtl/templates/requirements.md
</execution_context>
...
**Load milestone context (if exists, from /s2r:discuss-milestone):**
...
- Check for MILESTONE-CONTEXT.md (from /s2r:discuss-milestone)
...
|-------|---------|----------|--------|
| s2r-project-researcher | opus | sonnet | haiku |
| s2r-research-synthesizer | sonnet | sonnet | haiku |
| s2r-roadmapper | opus | sonnet | sonnet |
...
Spawn 4 parallel s2r-project-researcher agents with milestone-aware context:
...
Use template: ~/.claude/spec2rtl/templates/research-project/STACK.md
</output>
", subagent_type="s2r-project-researcher", model="{researcher_model}", description="Stack research")
...
Use template: ~/.claude/spec2rtl/templates/research-project/FEATURES.md
</output>
", subagent_type="s2r-project-researcher", model="{researcher_model}", description="Features research")
...
Use template: ~/.claude/spec2rtl/templates/research-project/ARCHITECTURE.md
</output>
", subagent_type="s2r-project-researcher", model="{researcher_model}", description="Architecture research")
...
Use template: ~/.claude/spec2rtl/templates/research-project/PITFALLS.md
</output>
", subagent_type="s2r-project-researcher", model="{researcher_model}", description="Pitfalls research")
```
...
Use template: ~/.claude/spec2rtl/templates/research-project/SUMMARY.md
Commit after writing.
</output>
", subagent_type="s2r-research-synthesizer", model="{synthesizer_model}", description="Synthesize research")
```

Display research complete banner and key findings:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Spec2RTL ► RESEARCH COMPLETE ✓
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Spec2RTL ► DEFINING REQUIREMENTS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
Spawn s2r-roadmapper agent with context:
...
", subagent_type="s2r-roadmapper", model="{roadmapper_model}", description="Create roadmap")
```
...
- Re-spawn roadmapper with revision context:
  ...
  ", subagent_type="s2r-roadmapper", model="{roadmapper_model}", description="Revise roadmap")
  ```
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Spec2RTL ► MILESTONE INITIALIZED ✓
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
`/s2r:discuss-phase [N]` — gather context and clarify approach
...
**Also available:**
- `/s2r:plan-phase [N]` — skip discussion, plan directly
...
- [ ] s2r-roadmapper spawned with phase numbering context
- [ ] Roadmap files written immediately (not draft)
- [ ] User feedback incorporated (if any)
- [ ] ROADMAP.md created with phases continuing from previous milestone
- [ ] All commits made (if planning docs committed)
- [ ] User knows next step is `/s2r:discuss-phase [N]`
